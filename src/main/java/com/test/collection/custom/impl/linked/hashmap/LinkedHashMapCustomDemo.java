package com.test.collection.custom.impl.linked.hashmap;

public class LinkedHashMapCustomDemo {

	public static void main(String[] args) {
		CustomLinkedHashMap<Integer, Integer> linkedHashMapCustom = new CustomLinkedHashMap<Integer, Integer>();
